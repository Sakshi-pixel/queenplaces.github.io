...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_bakery_open_tab(event, 'lite_theme')"><?php esc_html_e( 'Install With Customizer', 'vw-bakery' ); ?></button>	
		  <button class="tablinks" onclick="vw_bakery_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Install With Block Pattern', 'vw-bakery' ); ?></button>
			<button class="tablinks" onclick="vw_bakery_open_tab(event, 'gutenberg_editor')"><?php esc_html_e( 'Install With Gutunberg Block', 'vw-bakery' ); ?></button>	  
		...
		<div id="gutenberg_editor" class="tabcontent">
			...
			<?php }else{ ?>
				...
				<hr class="h3hr">
				<div class="vw-bakery-pattern-page">
			    	<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor' )); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Ibtana Settings','vw-bakery'); ?></a>
			    </div>
			<?php } ?>
		</div>	
